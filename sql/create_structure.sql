CREATE TABLE `geonames_geoname` (
  ...
  `name` VARCHAR(256) NOT NULL COMMENT 'name of geographical point (utf8)',
  `ascii_name` VARCHAR(256) NOT NULL COMMENT 'name of geographical point in plain ascii characters',
  ...
  `feature_code` VARCHAR(8) NOT NULL COMMENT 'see http://www.geonames.org/export/codes.html',
  `country_code` VARCHAR(2) NOT NULL COMMENT 'ISO-3166 2-letter country code',
  `cc2` VARCHAR(64) NOT NULL COMMENT 'alternate country codes, comma separated, ISO-3166 2-letter country code',
  `admin1` VARCHAR(64) NOT NULL COMMENT 'fipscode (subject to change to iso code), see exceptions below, see file admin1Codes.txt for display names of this code',
  `admin2` VARCHAR(64) NOT NULL COMMENT 'code for the second administrative division, a county in the US, see file admin2Codes.txt',
  `admin3` VARCHAR(32) NOT NULL COMMENT 'code for third level administrative division',
  `admin4` VARCHAR(32) NOT NULL COMMENT 'code for fourth level administrative division',
  `population` BIGINT(12) UNSIGNED NOT NULL,
  `elevation` VARCHAR(16) NOT NULL DEFAULT 0 COMMENT 'in meters',
...
CREATE TABLE `geonames_alternate_name` (
  ...
  `alternate_name` VARCHAR(256) NOT NULL COMMENT 'alternate name or name variant',
